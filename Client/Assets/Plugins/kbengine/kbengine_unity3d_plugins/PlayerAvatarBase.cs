/*
	...
	Please inherit this module, such as: (class PlayerAvatar : PlayerAvatarBase)
	tools = kbcmd
*/
...
namespace KBEngine
{
	...
	// Please inherit and implement "class PlayerAvatar : PlayerAvatarBase"
	public abstract class PlayerAvatarBase : Entity
	{
		public EntityBaseEntityCall_PlayerAvatarBase baseEntityCall = null;
		...
		{
			cellEntityCall = new EntityCellEntityCall_PlayerAvatarBase(id, className);
		}
